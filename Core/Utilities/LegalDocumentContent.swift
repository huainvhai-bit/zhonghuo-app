...
enum LegalDocumentContent {
    ...
    private static func privacyHTML() -> String {
        ...
        *{box-sizing:border-box}
        ...
        <header class="hero">
        <div class="badge">安心助手 App · 隐私政策</div>
        <h1>隐私政策</h1>
        <p class="subtitle">了解安心助手如何收集、使用、存储和保护你的个人信息。</p>
        <div class="meta"><span>生效日期：<strong>2026年5月2日</strong></span><span>最近更新：<strong>2026年5月2日</strong></span><span>提供方：<strong>安心助手项目团队</strong></span></div>
        ...
        <article class="card">
        <div class="notice"><strong>重要提示：</strong>安心助手重视你的隐私与数据安全。请在使用本 App 前仔细阅读本隐私政策。若你不同意本政策的任何内容，请停止使用本 App。</div>
        <div class="content">
        <section><h2>一、产品与适用范围</h2><p>安心助手是一款个人记录管理平台，帮助你整理重要信息、时光留言和本机签到提醒。</p><p>本隐私政策适用于你使用安心助手 App 及相关服务的全过程。</p></section>
        <section><h2>二、我们是谁</h2><p>安心助手 App 由<strong>安心助手项目团队</strong>提供。本政策中的“我们”指安心助手 App 及其提供方；“你”指注册、登录或使用本 App 的用户。</p><p>联系邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a><br>备用邮箱：<a href="mailto:huainvhai2@gmail.com">huainvhai2@gmail.com</a><br>官方网站：<a href="https://zhonghuo.zhonghuo.xyz">https://zhonghuo.zhonghuo.xyz</a></p></section>
        ...
        <section><h2>四、我们如何使用信息</h2><ul><li>提供、维护和改进安心助手 App 的基础功能与会员订阅服务；</li><li>帮助你管理时光留言、重要事项和本机签到提醒；</li><li>仅在你主动点击发送后，向你指定的用户展示已发送内容；</li><li>验证订阅状态、处理恢复购买、管理会员权益；</li><li>进行账号安全保护、异常行为排查、客服支持和故障修复；</li><li>遵守法律法规、监管要求和平台规则。</li></ul></section>
        ...
        <section><h2>七、会员订阅与支付</h2><p>安心助手可能提供自动续期订阅会员服务，例如月度会员和年度会员。会员权益、价格、周期和具体内容以 App 内展示及 App Store 购买页面为准。</p><div class="timeline">
        ...
        <section><h2>十一、未成年人保护</h2><p>安心助手主要面向具备相应民事行为能力的成年人使用。若你是未成年人，请在监护人同意和指导下使用本 App。若我们发现未在监护人同意下收集了未成年人的个人信息，我们会依法尽快删除或采取其他必要措施。</p></section>
        ...
        <section><h2>十四、联系我们</h2><p>提供方：安心助手项目团队<br>客服邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a><br>备用邮箱：<a href="mailto:huainvhai2@gmail.com">huainvhai2@gmail.com</a><br>官方网站：<a href="https://zhonghuo.zhonghuo.xyz">https://zhonghuo.zhonghuo.xyz</a></p></section>
        </div></article>
        </main>
        <footer class="footer">© 2026 安心助手. All rights reserved. ｜ <a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a></footer>
        </body>
        </html>
        """
    }
    ...
    private static func termsHTML() -> String {
        ...
        *{box-sizing:border-box}
        ...
        <main class="container">
        <header class="hero">
        <div class="badge">安心助手 App · 服务条款</div>
        <h1>服务条款</h1>
        <p class="subtitle">使用安心助手前，请阅读并理解本服务条款及相关重要说明。</p>
        <div class="meta"><span>生效日期：<strong>2026年5月2日</strong></span><span>最近更新：<strong>2026年5月2日</strong></span><span>提供方：<strong>安心助手项目团队</strong></span></div>
        ...
        <article class="card">
        <div class="notice"><strong>重要提示：</strong>安心助手提供的是数字化记录、提醒和手动分享工具。涉及重要事项、资产记录、医疗意愿或其他专业事项时，法律效力可能因地区和形式要求不同而不同。请在必要时咨询律师、公证机构、医疗机构或其他专业人士。</div>
        <div class="content">
        <section><h2>一、接受条款</h2><p>你下载、安装、注册、登录或使用安心助手 App，即表示你已阅读、理解并同意遵守本服务条款及《隐私政策》。若你不同意本条款，请停止使用本 App。</p><p>安心助手 App 由<strong>安心助手项目团队</strong>提供。联系邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a>。</p></section>
        <section><h2>二、服务内容</h2><p>安心助手是一款个人记录管理平台，帮助你整理重要信息并手动分享。</p><div class="grid">
        ...
        <section><h2>四、用户内容与授权</h2><p>你在安心助手 App 中创建、上传或保存的时光留言、重要事项、资产记录、文字、图片、音频、视频及其他内容，仍归你或原权利人所有。</p><p>为向你提供保存、展示、发送、提醒和协作等服务，你授权我们在必要范围内存储、处理、传输和展示相关内容。</p><p>你承诺你上传或设置发送的内容不侵犯他人合法权益，且你已获得接收人或其他相关人员的必要授权。</p></section>
        <section><h2>五、重要事项与说明</h2><p>安心助手提供的重要事项、资产管理和个人偏好记录功能，主要用于帮助用户记录和整理信息。</p><p>我们不提供法律、医疗、财务、税务、公证或投资建议。本 App 内生成或保存的文档、记录或模板，不必然具备法律效力。</p><p>若你希望相关安排具有正式法律效力，请根据所在地法律要求咨询律师、公证机构、医疗机构或其他专业人士，并完成必要的签署、见证、公证或备案程序。</p></section>
        ...
        <section><h2>七、会员订阅服务</h2><p>安心助手可能提供自动续期订阅会员服务，例如月度会员和年度会员。会员权益、价格、周期和具体内容以 App 内展示及 App Store 购买页面为准。</p><h3>1. 订阅与续费</h3><ul><li>订阅将通过你的 Apple ID 账户确认并扣款；</li><li>自动续期订阅会在当前订阅周期结束时自动续订，除非你在当前周期结束前至少 24 小时取消；</li><li>续费费用通常会在当前周期结束前 24 小时内从 Apple ID 账户扣除；</li><li>你可以在 iOS 系统的 Apple ID 订阅管理页面管理或取消订阅。</li></ul><h3>2. 取消订阅</h3><p>你可以前往 iPhone 设置或 App Store 的订阅管理页面取消自动续费。取消后，你仍可在当前已付费周期内继续使用会员权益，到期后会员权益将停止。</p><h3>3. 恢复购买</h3><p>如你更换设备、重新安装 App 或需要同步会员状态，可以使用 App 内“恢复购买”功能。恢复购买用于向 Apple 同步你的订阅记录，不会重复扣费。</p><h3>4. 退款</h3><p>通过 Apple App Store 购买的订阅，退款通常由 Apple 根据其规则处理。你可以通过 Apple 官方渠道申请退款。我们会根据 Apple 返回的退款或订阅状态更新会员权益。</p></section>
        <section><h2>八、用户行为规范</h2><p>你在使用安心助手 App 时不得：</p><ul><li>上传违法、侵权、欺诈、骚扰、恶意或侵犯他人隐私的内容；</li><li>冒充他人、盗用他人账号或未经授权添加他人联系方式；</li><li>干扰、破坏、攻击 App、服务器、网络或其他用户的正常使用；</li><li>利用 App 从事违法活动、侵犯他人合法权益或规避平台规则；</li><li>对 App 进行反向工程、破解、恶意抓取或未经授权的商业使用。</li></ul></section>
        <section><h2>九、知识产权</h2><p>安心助手 App 的软件、界面、图标、商标、文字、图片、交互设计、技术架构及相关内容，除用户自行上传内容外，均由我们或相关权利人依法享有知识产权。</p></section>
        ...
        <section><h2>十一、免责声明</h2><ul><li>安心助手 App 是数字化记录、提醒和手动分享工具，不保证任何记录内容当然具备法律效力；</li><li>定期签到不构成紧急救援、医疗服务或安全保证；</li><li>因网络、设备、系统、第三方服务或不可抗力导致的服务中断、数据延迟、展示异常等情况，我们会尽力修复，但不对超出合理控制范围的后果承担责任；</li><li>你应自行判断并核实重要事项，必要时咨询专业人士。</li></ul></section>
        <section><h2>十二、责任限制</h2><p>在法律允许的最大范围内，我们对因使用或无法使用安心助手 App 所产生的间接损失、预期利益损失、数据损失、业务中断或第三方索赔不承担责任。</p><p>如法律不允许完全排除责任，我们的责任将限于法律允许的最低范围。</p></section>
        ...
        <section><h2>十四、适用法律与争议解决</h2><p>本条款的订立、生效、履行、解释及争议解决，适用 <strong>中华人民共和国法律</strong>。</p><p>因本条款或安心助手 App 产生的争议，双方应先友好协商解决；协商不成的，提交安心助手团队所在地法院处理。</p></section>
        <section><h2>十五、条款更新</h2><p>我们可能根据产品功能、法律法规或运营需要更新本服务条款。重大变更时，我们会通过 App 内通知、弹窗、站内消息或页面公告等方式提醒你。</p><p>条款更新后，若你继续使用安心助手 App，即表示你接受更新后的条款。</p></section>
        <section><h2>十六、联系我们</h2><p>提供方：安心助手项目团队<br>客服邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a><br>备用邮箱：<a href="mailto:huainvhai2@gmail.com">huainvhai2@gmail.com</a><br>官方网站：<a href="https://zhonghuo.zhonghuo.xyz">https://zhonghuo.zhonghuo.xyz</a></p></section>
        </div></article>
        </main>
        <footer class="footer">© 2026 安心助手. All rights reserved. ｜ <a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a></footer>
        </body>
