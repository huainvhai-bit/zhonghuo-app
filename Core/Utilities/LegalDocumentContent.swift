...
enum LegalDocumentContent {
    ...
    private static func privacyHTML() -> String {
        ...
        *{box-sizing:border-box}
        ...
        <header class="hero">
        <div class="badge">安伴助手 · 隐私政策</div>
        <h1>隐私政策</h1>
        <p class="subtitle">了解安伴助手如何收集、使用、存储和保护你的个人信息。</p>
        <div class="meta"><span>生效日期：<strong>2026年5月2日</strong></span><span>最近更新：<strong>2026年5月2日</strong></span><span>提供方：<strong>安伴助手</strong></span></div>
        ...
        <div class="content">
        <section><h2>一、产品与适用范围</h2><p>安伴助手是一款个人记录管理平台，帮助你整理重要信息、时光留言和本机签到提醒。</p><p>本隐私政策适用于你使用安伴助手及相关服务的全过程。</p></section>
        <section><h2>二、我们是谁</h2><p>安伴助手由<strong>安伴助手</strong>提供。本政策中的“我们”指安伴助手及其提供方；“你”指注册、登录或使用本 App 的用户。</p><p>联系邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a><br>备用邮箱：<a href="mailto:huainvhai2@gmail.com">huainvhai2@gmail.com</a><br>官方网站：<a href="https://zhonghuo.zhonghuo.xyz">https://zhonghuo.zhonghuo.xyz</a></p></section>
        ...
        <section><h2>四、我们如何使用信息</h2><ul><li>提供、维护和改进安伴助手的基础功能与会员订阅服务；</li><li>帮助你管理时光留言、重要事项和本机签到提醒；</li><li>仅在你主动点击发送后，向你指定的用户展示已发送内容；</li><li>验证订阅状态、处理恢复购买、管理会员权益；</li><li>进行账号安全保护、异常行为排查、客服支持和故障修复；</li><li>遵守法律法规、监管要求和平台规则。</li></ul></section>
        ...
        <section><h2>十四、联系我们</h2><p>提供方：安伴助手<br>客服邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a><br>备用邮箱：<a href="mailto:huainvhai2@gmail.com">huainvhai2@gmail.com</a><br>官方网站：<a href="https://zhonghuo.zhonghuo.xyz">https://zhonghuo.zhonghuo.xyz</a></p></section>
        </div></article>
        </main>
    ...
    private static func termsHTML() -> String {
        ...
        *{box-sizing:border-box}
        ...
        <div class="content">
        <section><h2>一、接受条款</h2><p>你下载、安装、注册、登录或使用安伴助手，即表示你已阅读、理解并同意遵守本服务条款及《隐私政策》。若你不同意本条款，请停止使用本 App。</p><p>安伴助手由<strong>安伴助手</strong>提供。联系邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a>。</p></section>
        ...
        <section><h2>四、用户内容与授权</h2><p>你在安伴助手中创建、上传或保存的时光留言、重要事项、资产记录、文字、图片、音频、视频及其他内容，仍归你或原权利人所有。</p><p>为向你提供保存、展示、发送、提醒和协作等服务，你授权我们在必要范围内存储、处理、传输和展示相关内容。</p><p>你承诺你上传或设置发送的内容不侵犯他人合法权益，且你已获得接收人或其他相关人员的必要授权。</p></section>
        ...
        <section><h2>八、用户行为规范</h2><p>你在使用安伴助手时不得：</p><ul><li>上传违法、侵权、欺诈、骚扰、恶意或侵犯他人隐私的内容；</li><li>冒充他人、盗用他人账号或未经授权添加他人联系方式；</li><li>干扰、破坏、攻击 App、服务器、网络或其他用户的正常使用；</li><li>利用 App 从事违法活动、侵犯他人合法权益或规避平台规则；</li><li>对 App 进行反向工程、破解、恶意抓取或未经授权的商业使用。</li></ul></section>
        <section><h2>九、知识产权</h2><p>安伴助手的软件、界面、图标、商标、文字、图片、交互设计、技术架构及相关内容，除用户自行上传内容外，均由我们或相关权利人依法享有知识产权。</p></section>
        ...
        <section><h2>十一、免责声明</h2><ul><li>安伴助手是数字化记录、提醒和手动分享工具，不保证任何记录内容当然具备法律效力；</li><li>定期签到不构成紧急救援、医疗服务或安全保证；</li><li>因网络、设备、系统、第三方服务或不可抗力导致的服务中断、数据延迟、展示异常等情况，我们会尽力修复，但不对超出合理控制范围的后果承担责任；</li><li>你应自行判断并核实重要事项，必要时咨询专业人士。</li></ul></section>
        <section><h2>十二、责任限制</h2><p>在法律允许的最大范围内，我们对因使用或无法使用安伴助手所产生的间接损失、预期利益损失、数据损失、业务中断或第三方索赔不承担责任。</p><p>如法律不允许完全排除责任，我们的责任将限于法律允许的最低范围。</p></section>
        ...
        <section><h2>十四、适用法律与争议解决</h2><p>本条款的订立、生效、履行、解释及争议解决，适用 <strong>中华人民共和国法律</strong>。</p><p>因本条款或安伴助手产生的争议，双方应先友好协商解决；协商不成的，提交安伴助手所在地法院处理。</p></section>
        <section><h2>十五、条款更新</h2><p>我们可能根据产品功能、法律法规或运营需要更新本服务条款。重大变更时，我们会通过 App 内通知、弹窗、站内消息或页面公告等方式提醒你。</p><p>条款更新后，若你继续使用安伴助手，即表示你接受更新后的条款。</p></section>
        <section><h2>十六、联系我们</h2><p>提供方：安伴助手<br>客服邮箱：<a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a><br>备用邮箱：<a href="mailto:huainvhai2@gmail.com">huainvhai2@gmail.com</a><br>官方网站：<a href="https://zhonghuo.zhonghuo.xyz">https://zhonghuo.zhonghuo.xyz</a></p></section>
        </div></article>
        </main>
        <footer class="footer">© 2026 安伴助手. All rights reserved. ｜ <a href="mailto:support@zhonghuo.app">support@zhonghuo.app</a></footer>
        </body>
