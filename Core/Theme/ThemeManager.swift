...
enum L10n {
    ...
    private static let translations: [String: [String: String]] = [
        "chinese": [
            ...
            "locationDesc": "定位服务用于在您授权后记录位置信息，便于本人状态记录和共享展示。App 不会因未签到或未操作自动发送定位。",
            "signInInterval": "签到间隔",
            "silentMode": "静默模式",
            "todaySteps": "今日步数",
            "deviceBattery": "设备电量",
            ...
            "onboardingSafeCheckInDesc": "打开 App 即可更新签到记录。本机提醒只会提醒您本人，不会自动通知家人。",
            "onboardingCapsule": "时光留言",
            "onboardingCapsuleDesc": "写下想说的话，保存文字、语音或视频。留言只有在您主动点击发送后，绑定家人才可查看。",
            "onboardingWill": "重要事项",
            "onboardingWillDesc": "记录资产、家庭事务和个人安排。内置模板帮助您把重要事项整理清楚。",
            ...
            "familyGuardHint": "使用上方功能绑定家人，互相查看最近签到记录",
            ...
            "scanFamilySubtitle": "扫描家人的邀请码，双方确认后建立共享关系",
            "scanFamilyButton": "开始扫码",
            "shareQRCodeTitle": "分享我的二维码",
            "shareQRCodeSubtitle": "家人扫描下方二维码后，需要双方确认才会关联",
            ...
            "noFamilyBoundHint": "使用上方功能绑定家人，互相查看最近签到记录",
            "familyCountSuffix": "人",
            "checkingNormal": "记录正常",
            ...
            "receivedCapsuleHint": "家人手动发送的留言会出现在这里",
            "from": "来自",
            "unread": "未读",
            "read": "已读",
            "settingsTitle": "设置",
            ...
            "goSettings": "去设置",
            "locationAlwaysHint": "如需持续记录本人状态，可开启“始终允许”定位权限。位置信息不会因未签到或未操作自动发送。",
            "prompt": "提示",
            "positionAlways": "始终允许",
            "today": "今日",
            "steps": "步",
        ...
        "english": [
            ...
            "locationDesc": "Location is recorded only after your permission for personal status records and shared display. The app does not automatically send location because of missed check-ins or inactivity.",
            ...
            "onboardingSafeCheckInDesc": "Open the app to update your check-in record. Local reminders only remind you and do not automatically notify family.",
            ...
            "onboardingWillDesc": "Record assets, family matters, and personal arrangements for personal organization.",
            "onboardingFamilyGuard": "Family Sharing",
            "onboardingFamilyGuardDesc": "After mutual confirmation, family members can view each other's latest check-in time.",
            ...
            "familyGuardHint": "Bind family above to view each other's latest check-in records.",
            ...
            "homeWithYou": "Anxinji with you",
            "familyProtected": "Family sharing is enabled",
            "familyCheckStatus": "View family latest check-in records",
            "autoCheckIn": "Open the app to check in automatically",
            "safeCheckIn": "Check-in records",
            "familyGuarding": "Sharing",
            ...
            "shareQRCodeSubtitle": "Family members can scan this QR code; both sides must confirm before sharing starts",
            ...
            "receivedCapsuleHint": "Messages manually sent by family will appear here.",
            "from": "From",
            "unread": "Unread",
            "read": "Read",
            ...
            "locationAlwaysHint": "If you need continuous personal status records, you may enable \"Always\" location access. Location is not automatically sent because of missed check-ins or inactivity.",
            "prompt": "Notice",
        ...
        "japanese": [
            "appName": "安心記",
            "appTagline": "大切な時間を記録し、家族と安心して共有",
            "loginTitle": "ログイン",
            ...
            "locationDesc": "許可された場合のみ、本人の状態記録と共有表示のため位置情報を記録します。未チェックインや未操作を理由に位置情報を自動送信することはありません。",
            ...
            "onboardingSafeCheckInDesc": "アプリを開くとチェックイン記録を更新できます。本機通知は本人だけに届き、家族へ自動通知しません。",
            "onboardingCapsule": "タイムメッセージ",
            "onboardingCapsuleDesc": "テキスト、音声、動画メッセージを保存できます。家族が見られるのは、あなたが手動送信した後だけです。",
            "onboardingWill": "重要事項",
            "onboardingWillDesc": "資産、家族事項、個人メモを整理できます。",
            "onboardingFamilyGuard": "家族共有",
            "onboardingFamilyGuardDesc": "双方確認後、お互いの最新チェックイン時刻を確認できます。",
            ...
            "familyGuardHint": "上の機能で家族を追加し、お互いの最新チェックイン記録を確認できます。",
            ...
            "bindFailed": "紐付け失敗",
            "homeWithYou": "安心記とともに",
            "familyProtected": "家族共有が有効です",
            "familyCheckStatus": "家族の最新チェックイン記録を確認",
            ...
            "testSuccess": "成功",
            "testFailed": "失敗",
            "appCopyright": "© 2026 安心記 App. All rights reserved.",
            "maleGender": "男性",
            "femaleGender": "女性",
            ...
            "shareQRCodeSubtitle": "家族が下のQRコードを読み取り、双方確認後に共有を開始できます",
            ...
            "receivedCapsuleHint": "家族が手動送信したメッセージがここに表示されます。",
            "from": "送信元",
            "unread": "未読",
            "read": "既読",
            "settingsTitle": "設定",
            ...
            "goSettings": "設定へ",
            "locationAlwaysHint": "継続的な本人状態記録が必要な場合は「常に許可」を有効にできます。未チェックインや未操作を理由に位置情報を自動送信することはありません。",
            "prompt": "ヒント",
            "positionAlways": "常に許可",
            "today": "今日",
            "steps": "歩",
        ...
        "korean": [
            "appName": "안심기",
            "appTagline": "중요한 시간을 기록하고 가족과 안심 공유",
            "loginTitle": "로그인",
            ...
            "locationDesc": "허용한 경우에만 본인 상태 기록과 공유 표시를 위해 위치를 기록합니다. 체크인 누락이나 미사용 때문에 위치를 자동 전송하지 않습니다.",
            ...
            "onboardingFamilyGuard": "가족 공유",
            "onboardingFamilyGuardDesc": "양쪽이 확인한 후 서로의 최신 체크인 시간을 볼 수 있습니다.",
            ...
            "familyGuardHint": "위 기능으로 가족을 연결하고 서로의 최신 체크인 기록을 확인하세요.",
            ...
            "bindFailed": "연결 실패",
            "homeWithYou": "안심기와 함께",
            "familyProtected": "가족 공유가 활성화되었습니다",
            "familyCheckStatus": "가족의 최신 체크인 기록 보기",
            ...
            "shareQRCodeSubtitle": "가족이 아래 QR 코드를 스캔하고 양쪽 확인 후 공유가 시작됩니다",
            ...
            "receivedCapsuleHint": "가족이 직접 보낸 메시지가 여기에 표시됩니다.",
            "from": "발신",
            "unread": "읽지 않음",
            "read": "읽음",
            "settingsTitle": "설정",
            ...
            "goSettings": "설정으로 이동",
            "locationAlwaysHint": "지속적인 본인 상태 기록이 필요하면 \"항상 허용\"을 켤 수 있습니다. 체크인 누락이나 미사용 때문에 위치를 자동 전송하지 않습니다.",
            "prompt": "안내",
