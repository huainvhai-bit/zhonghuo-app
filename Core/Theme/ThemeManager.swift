...
enum L10n {
    ...
    private static let translations: [String: [String: String]] = [
        "chinese": [
            ...
            "onboardingWill": "遗嘱嘱托",
            "onboardingWillDesc": "提前规划财产分配、丧葬意愿等身后事。内置模板帮助你快速完成，让家人少一份负担。",
        ...
        "english": [
            ...
            "onboardingWill": "Wills & Wishes",
            "onboardingWillDesc": "Plan asset distribution and funeral wishes ahead of time. Templates help you finish faster.",
        ...
        "japanese": [
            ...
            "onboardingWill": "遺言・希望",
            "onboardingWillDesc": "財産分配や葬儀の希望を事前に整理できます。",
        ...
        "korean": [
            ...
            "onboardingWill": "유언과 바람",
            "onboardingWillDesc": "재산 분배와 장례 희망을 미리 정리할 수 있습니다.",
