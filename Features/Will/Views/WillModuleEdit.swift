...
private struct CachedTemplates {
    static let propertyTemplates: [(title: String, content: String)] = [
        ("标准财产分配", """
    ...
    static let heirsTemplates: [(title: String, content: String)] = [
        ("继承人指定", """
    ...
    static let specialItemsTemplates: [(title: String, content: String)] = [
        ("特殊物品分配", """
    ...
    static let funeralTemplates: [(title: String, content: String)] = [
        ("简约葬礼", """
    ...
    static let otherInstructionsTemplates: [(title: String, content: String)] = [
        ("其他嘱托", """
